...
`98.38m/87.16m/80.37m`. A reviewed version-1101 pre-mutation save/UI
observation also maps the nonstandard Tournament variation
`98.38m/80.37m/60.00m`; it does not add or change a named Strategy preset.
