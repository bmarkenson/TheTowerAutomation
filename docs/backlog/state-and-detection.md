...
- [ ] Replace non-running recovery with an interruptible five-minute timer.
  ...
  - Promote checkpointed aggregate candidate `240b63f`, which contains
    cross-owner hardening code commit `f3cf804`, then confirm the resulting
    production commit for `ISSUE-2026-041` at one natural completed-battle
    Home launch: Free Ticket
