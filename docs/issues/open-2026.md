...
- **Status:** Feature commit `733033b` removes the synchronous wait: Pause,
  ...
  Keep this dossier open until the deployed runtime confirms clean Stop
  interruption and lock release at a natural Home setup boundary; the pending
