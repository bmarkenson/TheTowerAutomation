...
- **Status:** Commit `ab84a3c` is deployed in production. Replacement-process
  ...
  [ISSUE-2026-030](#utility-dissonance-star-was-labeled-as-attack). The
...
**Stable ID:** `ISSUE-2026-030` · **Lifecycle:** `repair_awaiting_confirmation` · **Routing class:** `repair_awaiting_confirmation`
...
- **Repair:** The detector now records localized purple as Dissonance-family
  ...
  1,690 tests.
- **Status:** Repair awaits integration, production promotion, a fresh running
  observation, and the natural Game Over record. Require
