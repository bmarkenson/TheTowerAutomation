...
**Stable ID:** `ISSUE-2026-037` · **Lifecycle:** `repair_awaiting_confirmation` · **Routing class:** `repair_awaiting_confirmation`
...
- **Safety response:** Investigation and repair were repository-only. No live
...
- **Status:** Repository repair implemented; deployment and Windows WPF
  confirmation remain pending. Close only after a long noisy/rotated-log WPF
