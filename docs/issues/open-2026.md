...
- **Live result:** The replacement adopted `farm_t19_ad_assist` for the active
  ...
  **Astral Deliverance** with confidence `0.9649463891983032`; no check failed.
  ...
  `repair_awaiting_confirmation` until that publish/activation path and the
  agreed dropdown queue behavior are confirmed. The active native dashboard
  feature owns that affordance; this repair does not edit its WPF files.
