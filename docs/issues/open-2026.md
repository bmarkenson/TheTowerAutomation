...
- **Status:** Repair awaits integration, production promotion, and one natural
  paused manual-start confirmation that the running-source baseline completes
  and No Strategy inventory follows. The active confirmation is tracked in the
  [runtime backlog](../backlog/runtime-and-validation.md#runtime-control).
