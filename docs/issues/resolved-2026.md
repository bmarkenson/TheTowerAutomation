...
- **Cause and resolution:** The missing typed Game Over cleanup dispatcher was
  ...
  records the old report segment, and allows only a later forced save identity
  to authorize successor adoption.
- **Regression:** A real-manager/main-loop case proves successful Surrender,
  ...
  only after the successor's forced save identity is established.
