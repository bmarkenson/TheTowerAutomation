...
- **Status:** Open and confirmed. Stop must terminate the in-progress setup
  without cleanup input, while Pause may continue waiting for Resume. The
  active repair belongs in
