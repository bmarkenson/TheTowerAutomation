...
from core.input_named import tap_named, swipe_named, load_clickmap
import cv2
import os
import json
import time
...
def handle_game_over():
    ...
    tap_named(clickmap, "more_stats")
    time.sleep(1.5)

    swipe_named(clickmap, "goto_top")
    time.sleep(1.5)
    ...
    swipe_named(clickmap, "more_stats_pg2")
    time.sleep(1.2)
    ...
    swipe_named(clickmap, "more_stats_pg3")
    time.sleep(1.2)
    ...
    tap_named(clickmap, "close_more_stats")
    time.sleep(1.2)
